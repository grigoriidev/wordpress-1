...
Tags: json,webservice,api,connect,template,import,content,cache,opendata,parser,html,application
...
Beta feature in Version 1.2.11: On the Optionpage you can set an oAuth-Bearer-Accesscode for authentification at JSON-Server: This Bearer-Code is added to the Request-Header. Please try if you need such a feature.
...
* pass GET-Variables to use a dynamic JSON-Feed-URL ("talk to API / webservice"),

* store Templates independent of pages,

* more Shortcode-Parameters,

* executing Shortcodes inside a template and so on.
...
Version 1.2.10: caching-bugfix and beta-feature oAuth