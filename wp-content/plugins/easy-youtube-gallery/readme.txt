...
* `playsinline` controls whether videos play inline or fullscreen in an HTML5 player on iOS. Learn more on [Google Developers](https://developers.google.com/youtube/player_parameters?hl=en#playsinline)
