...
<div id="mobile_visible">
<h1 class="entry-title"><?php the_title(); ?></h1>
</div>
<div id="mobile_hidden" style="width: 100%; display: inline-block;">
<div style="width: 30%; float: left;">
<h1 class="entry-title"><?php the_title(); ?></h1>
</div>
<div style="width: 70%; float: right; display: inline-block;">
<div class="portfolionav clearfix" style="float: right;">

<?php kadence_previous_post_link_plus( array('order_by' => 'menu_order', 'loop' => true, 'format' => '%link', 'link' => '<i class="icon-chevron-left"></i>') ); ?><?php global $virtue; if( !empty($virtue['portfolio_link'])){ ?>
